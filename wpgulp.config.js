...
const projectURL = 'http://local.haddad.hr';
...
const styleSRC = './public/css/src/image-haddad-wp-public.scss';
// Path to place the compiled CSS file. Default set to root folder.
const styleDestination = './public/css/';

// Path to admin .scss file.
const adminSRC = './admin/css/src/image-haddad-wp-admin.scss';
// Path to place the compiled CSS file. Default set to root folder.
const adminCSSDestination = './admin/css/';
...
const watchStyles = './public/css/src/**/*.scss';
...
const textDomain = 'image-haddad-wp';

// Name of the translation file.
const translationFile = 'image-haddad-wp.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'Image Haddad WP';

// Where can users report bugs.
const bugReport = 'https://micemade/';

// Last translator Email ID.
const lastTranslator = 'Alen Širola <alen@micemade.com>';

// Team's Email ID.
const team = 'Alen Širola <alen@micemade.com>';
